 ...
 * @author GRIP
 */
public class HighGoalGRIP implements VisionPipeline {
	...
	public void process(Mat source0) {
		...
		double[] hsvThresholdHue = { 63.12949640287769, 96.6666666666667 };
		double[] hsvThresholdSaturation = { 38.98381294964029, 151.969696969697 };
		...
		// an arraylist to hold all the MatOfPoints that could be high goal
		// components
		List<MatOfPoint> possibleGoal = new ArrayList<MatOfPoint>();

		// filters out the contours that might be boiler vision targets
		processContours(filterContoursOutput, possibleGoal);
		
		for(MatOfPoint mOP: possibleGoal){
			
		}
		try {
			vision.putNumber("possibleGoalSize", possibleGoal.size());
