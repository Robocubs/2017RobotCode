...
public class GripPipelin implements VisionPipeline {
	...
	public void process(Mat source0) {
		...
		// filters out the contours that might be gear vision targets
		processContours(filterContoursOutput, possibleRect);
	...
	// if (Imgproc.contourArea(mOP) > 1200 && Imgproc.isContourConvex(new
