 ...
 *
 */
public class AutonomousCommandOld extends Command {
	...
	public static final double AUTO_DRIVE_SPEED = -.8;
	...
	private boolean pidStarted;
	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS

	// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=VARIABLE_DECLARATIONS

	// BEGIN AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
	public AutonomousCommandOld() {
...
//		if (Math.abs(actualDriveSpeed) < Math.abs(AUTO_DRIVE_SPEED))
//			actualDriveSpeed += .03;
//		RobotMap.driveTrainRM.arcadeDrive(actualDriveSpeed, AUTO_TURN_CORRECT);
		RobotMap.driveTrainRM.arcadeDrive(-1 * AUTO_DRIVE_SPEED, AUTO_TURN_CORRECT);
	}
...
//	}
	...
	private void backwardsPID() {
		if (!pidStarted) {
			Robot.driveTrain.setPIDtoAngle(RobotMap.navx.getYaw());
			pidStarted = true;
		}
//		switch (currentState) {
//		case 0: // DONE
...
//		case 1: // DRIVING_FORWARD
			if (Robot.driveTrain.getLeftDistance() > -1.4 * DRIVE_FORWARD_DISTANCE
					&& Robot.driveTrain.getRightDistance() > -1.4 * DRIVE_FORWARD_DISTANCE) {
				Robot.driveTrain.driveBackwardsPID();
			} else {
				if (!Robot.driveTrain.isPIDnull()) {
